...
import com.readinessit.livraria.config.audit.AuditEventConverter;
import com.readinessit.livraria.domain.PersistentAuditEvent;
...
import static com.readinessit.livraria.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
